...
export default function AdminDashboard() {
  ...
  const [alertForm, setAlertForm] = useState({
    type: 'flood', region: '', message: '', severity: 'moderate'
  });
...
const fetchAll = async () => {
  ...
  const createAlert = async () => {
    ...
    try {
      ...
      setAlertForm({ type: 'flood', region: '', message: '', severity: 'moderate' });
              ...
              {alerts.length === 0
                ...
                : alerts.map(a => (
                  <div key={a._id} style={{
                    ...
                    <p style={{ color: '#94a3b8', fontSize: 13, margin: '0 0 8px' }}>{a.message}</p>
